...
const NUMEROSMESES = 12;
document.write("El número de meses es  " + NUMEROSMESES + "</br>");
const NUMEROSEMANA = 7;
document.write("El número de días en una semana es  " + NUMEROSEMANA + "</br>");
let numeroHabitantes = 3.3;
